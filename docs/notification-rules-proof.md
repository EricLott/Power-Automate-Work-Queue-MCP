...
This is implementation and local safety evidence. The optional EmailSender now uses three fixed 30-second connector retries before recording a rejected delivery. A live tenant validation of persisted notification-rule configuration, cooldown behavior across multiple attempts, connector acceptance, recipient delivery, and restricted configuration identities remains open under #48, #49, #50, and G14.
